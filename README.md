...
Este projeto é o painel administrativo separado da loja SQM. Ele usa as mesmas chaves do Redis/Upstash para compartilhar produtos, pedidos e o HTML publicado com a loja.
...
3. Use o MESMO `UPSTASH_REDIS_REST_URL` e `UPSTASH_REDIS_REST_TOKEN` da loja.
